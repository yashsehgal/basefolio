...
const ExploreHackathonsSection: React.FunctionComponent = () => {
  const [exploreHackathonsList, setExploreHackathonsList] = useState<
  ...
  return (
    <Section id="explore-hackathons-section">
      ...
      <Section className={cn("grid grid-cols-2 gap-6 max-md:grid-cols-1")}>
        {exploreHackathonsList.map(
...
export { ExploreHackathonsSection };
