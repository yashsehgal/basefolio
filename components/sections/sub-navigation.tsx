...
type SubNavigationOptionType = "discover" | "hackathons" | "builders" | "projects";
...
const SubNavigation: React.FunctionComponent<React.HTMLAttributes<HTMLDivElement>> = ({
  className,
  ...props
}) => {
        ...
        {SubNavigationOptions.map((option, index) => {
          return (
            <Button
              ...
              className={cn(pathname !== option.path && "shadow-none hover:shadow-none", "uppercase text-sm")}
