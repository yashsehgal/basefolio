...
const ExperienceTab: React.FunctionComponent = () => {
  const [experience, setExperience] = useState<Array<AuthorizedUserExperienceType>>([]);
...
const ExperienceRowItem: React.FunctionComponent<ExperienceRowItemsProps> = ({
  ...
  const [currentExperienceInput, setCurrentExperienceInput] = useState<AuthorizedUserExperienceType>({
    title: "",
    company: {
      name: "",
      website: ""
  ...
  return (
    <div className="experience-row-card">
    </div>
  )
}
