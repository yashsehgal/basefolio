...
const UserAuthenticationProvider: React.FunctionComponent<React.HTMLAttributes<HTMLDivElement>> = ({ children, ...props }) => {
  const [userData, setUserData] = useState<AuthorizedUserType>(INITIAL_USER_AUTHORIZATION);
